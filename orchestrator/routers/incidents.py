...
async def list_incidents(
    ...
    """Legacy endpoint retained for compatibility; application history is scoped elsewhere."""
    return {"incidents": [], "count": 0, "detail": "Use /applications/{application_id}/incidents"}
